        ...
        <div className="min-h-screen bg-gradient-to-br from-teal-50 via-teal-100 to-sky-100 flex items-center justify-center relative overflow-hidden">
            ...
            >
                    ...
                    {!isSubmitted ? (
                        <form onSubmit={handleSubmit}>
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className='w-full py-3 px-4 bg-gradient-to-r from-teal-700 to-teal-500 text-white font-bold rounded-lg shadow-lg hover:from-teal-400 hover:to-teal-800 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 focus:ring-offset-white transition duration-200'
                                type='submit'
                            >
                ...
                <div className='px-8 py-4 bg-gray-50 flex justify-center'>
                    <Link to={"/login"} className='text-sm text-teal-600 hover:underline flex items-center'>
